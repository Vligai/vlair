...
class CertificateAnalyzer:
    ...
    COMMON_BRANDS = [
        ...
        'instagram', 'twitter', 'linkedin', 'netflix', 'adobe', 'ebay',
        'dropbox', 'outlook', 'office365', 'icloud', 'chase', 'wellsfargo',
        'bankofamerica', 'citibank', 'americanexpress'
    ]
...
Examples:
  ...
  python analyzer.py --file-list domains.txt --format json
    ...
    parser.add_argument('--format', '-fmt', choices=['json', 'txt'], default='txt',
