...
class Reporter:
    ...
    def format_console(
        self, input_value: str, input_type: str, scorer: RiskScorer, iocs: Dict[str, List], tool_results: Dict[str, Any]
    ) -> str:
        """
...
def main():
    ...
    tool_results = {"hash_lookup": {"verdict": "MALICIOUS"}, "eml_parser": {"authentication": {"spf": {"result": "fail"}}}}
