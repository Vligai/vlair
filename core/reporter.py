...
class Reporter:
    ...
    def format_console(self, input_value: str, input_type: str,
                       scorer: RiskScorer, iocs: Dict[str, List],
        ...
        lines.append(f" {Colors.BOLD}VERDICT: {verdict_color}{verdict}{Colors.RESET}"
        ...
        if any(iocs.values()):
            ...
            for ioc_type, values in iocs.items():
                if values:
                    ...
                    lines.append(f"  {ioc_type.capitalize()} ({len(values)}): "
    ...
    def format_json(self, input_value: str, input_type: str,
                    scorer: RiskScorer, iocs: Dict[str, List],
                    tool_results: Dict[str, Any]) -> str:
        """
    ...
    def format_verbose(self, input_value: str, input_type: str,
                       scorer: RiskScorer, iocs: Dict[str, List],
                       tool_results: Dict[str, Any]) -> str:
        """
