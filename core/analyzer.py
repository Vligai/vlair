...
def main():
    ...
    if args.quiet:
        ...
        print(reporter.format_json(result["input"], result["type"], result["scorer"], result["iocs"], result["tool_results"]))
    elif args.verbose:
        print(
            reporter.format_verbose(result["input"], result["type"], result["scorer"], result["iocs"], result["tool_results"])
        )
    else:
        print(
            reporter.format_console(result["input"], result["type"], result["scorer"], result["iocs"], result["tool_results"])
        )
