...
class InvestigationStateManager:
    ...
    def save(self, state: InvestigationState) -> bool:
        ...
        try:
            ...
            cursor.execute("DELETE FROM investigation_steps WHERE investigation_id = ?", (state.id,))
            cursor.execute("DELETE FROM remediation_actions WHERE investigation_id = ?", (state.id,))
    ...
    def load(self, investigation_id: str) -> Optional[InvestigationState]:
        ...
        try:
            ...
            cursor.execute("SELECT * FROM remediation_actions WHERE investigation_id = ?", (investigation_id,))
    ...
    def delete(self, investigation_id: str) -> bool:
        ...
        try:
            ...
            cursor.execute("DELETE FROM remediation_actions WHERE investigation_id = ?", (investigation_id,))
            cursor.execute("DELETE FROM investigation_steps WHERE investigation_id = ?", (investigation_id,))
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            last_investigation = {"id": last_row[0], "created_at": last_row[1]} if last_row else None
